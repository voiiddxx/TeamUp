...
const MatchDetail = () => {
  ...
  return (
    <div className='w-[700px] flex flex-col items-center justify-center' >
        <textarea className='h-[200px] w-[700px] outline-none  bg-stone-800 border border-zinc-700 px-4 py-2 focus:border-green-500' placeholder='Match Details | Rules | Guildlens : Note' ></textarea>
